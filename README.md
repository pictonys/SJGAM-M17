...
- **Оперативная память:** 256MB DDR3 - Samsung K4B1G0846F-HCH9 - 2 чипа по 128MB DDR3 SDRAM, работающих в 480 МГц (вплоть до 667 МГц, но напряжения не хватает, консоль зависает при насильном выставлении МГц).
...
- **Управление:** механическое (кнопки громкости + / - (работают в 0gpio-keys), кнопки start / select, тумблер состояния консоли On / Off, два аналоговых стика с кнопками R3 / L3, шифты L1 / R1 / L2 / R2, кнопки D-Pad и A / B / Y / X (работают в i2c-keys).
