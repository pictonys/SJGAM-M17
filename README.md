...
- **Встроенная память (eMMC NAND Flash):** Toshiba/Kioxia THGBMDG5D1LBAIL (форм-фактор BGA153) - 4 GB, интерфейс eMMC 5.0.
...
- **Управление:** механическое - низкопрофильные тактовые SMD кнопки громкости + / - и кнопки Start / Select, тумблер состояния консоли On / Off, два аналоговых стика (подделка на стики Nintendo Switch, только в оригинале они на шлейфе, а в нашей подделке они на пинах) с кнопками R3 / L3, шифты/курки L1 / R1 / L2 / R2, кнопки D-Pad (UP - DOWN - LEFT - RIGHT) и родные Xbox'овские A / B / Y / X.
