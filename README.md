...
- 2: Переход из под режима LOADER через кнопку в условном RKDevelopTool.
...
[serial 1](Photos/uart1.jpg) расположен позле TEST POINT, и как видим, добрый товарищ китаец его не включил!
